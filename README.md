...
| Name                                                                                                                                                    | Description                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| [@rnx-kit/patcher-rnmacos](https://github.com/microsoft/rnx-kit/tree/main/incubator/patcher-rnmacos)                                                    | EXPERIMENTAL - USE WITH CAUTION - A tool to generate patches and apply them to a codebase                           |
| [@rnx-kit/rn-changelog-generator](https://github.com/microsoft/rnx-kit/tree/main/incubator/rn-changelog-generator)                                      | EXPERIMENTAL - USE WITH CAUTION - Generate a markdown-formatted list of changes between two version of react-native |
