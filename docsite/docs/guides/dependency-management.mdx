...
advantage being that `fix-dependencies` could run as its own task with isolated
logging and error handling. And, you can run it in parallel with other tasks.
