...
export type TransformerSettings = {
  ...
  /** Whether to trace babel plugin performance */
  traceBabelPlugins?: boolean;

  /** A trace function for recording timing information about the transformation process, no-op if not tracing */
  trace: TraceFunction;
};
