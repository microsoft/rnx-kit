...
export const defaultCompoundButtonTokens: TokenSettings<
  CompoundButtonTokens,
  Theme
> = (theme: Theme): CompoundButtonTokens => ({
  medium: {
    ...
    hasContent: {
      ...
      primary:
        (!isHighContrast(theme) && {
          focused: {
            paddingHorizontal:
              globalTokens.size120 - globalTokens.stroke.width20,
          },
          circular: {
            focused: {
              paddingHorizontal:
                globalTokens.size160 - globalTokens.stroke.width20,
            },
          },
          square: {
            focused: {
    ...
    hasContent: {
      ...
      primary:
        (!isHighContrast(theme) && {
          focused: {
            paddingHorizontal:
              globalTokens.size80 - globalTokens.stroke.width20,
          },
          circular: {
            focused: {
              paddingHorizontal:
          ...
          square: {
            focused: {
              paddingHorizontal:
                globalTokens.size80 - globalTokens.stroke.width10,
            },
          },
        }) ||
        undefined,
      ...
      primary:
        (!isHighContrast(theme) && {
          ...
          circular: {
            focused: {
              paddingHorizontal:
                globalTokens.size200 - globalTokens.stroke.width20,
            },
          },
          square: {
            focused: {
              paddingHorizontal:
                globalTokens.size160 - globalTokens.stroke.width10,
            },
          },
        }) ||
        undefined,
