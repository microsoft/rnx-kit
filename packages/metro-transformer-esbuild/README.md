...
# @rnx-kit/metro-transformer-router

[![Build](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml/badge.svg)](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml)
[![npm version](https://img.shields.io/npm/v/@rnx-kit/metro-transformer-router)](https://www.npmjs.com/package/@rnx-kit/metro-transformer-router)
...
```sh
yarn add @rnx-kit/metro-transformer-router --dev
```

or if you're using npm

```sh
npm add --save-dev @rnx-kit/metro-transformer-router
```
