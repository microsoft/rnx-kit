...
# @rnx-kit/tools-manifest

[![Build](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml/badge.svg)](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml)
[![npm version](https://img.shields.io/npm/v/@rnx-kit/tools-manifest)](https://www.npmjs.com/package/@rnx-kit/tools-manifest)
...
```sh
yarn add @rnx-kit/tools-manifest --dev
```

or if you're using npm

```sh
npm add --save-dev @rnx-kit/tools-manifest
```
