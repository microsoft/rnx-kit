...
# @rnx-kit/types-metro-transformer

[![Build](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml/badge.svg)](https://github.com/microsoft/rnx-kit/actions/workflows/build.yml)
[![npm version](https://img.shields.io/npm/v/@rnx-kit/types-metro-transformer)](https://www.npmjs.com/package/@rnx-kit/types-metro-transformer)
...
```sh
yarn add @rnx-kit/types-metro-transformer --dev
```

or if you're using npm

```sh
npm add --save-dev @rnx-kit/types-metro-transformer
```
