import { writeThirdPartyNotices, IWriteThirdPartyNoticesOptions } from "@rnx-kit/third-party-notices";
...
export function rnxWriteThirdPartyNotices(
  ...
  let args : IWriteThirdPartyNoticesOptions = {
    ...
    ignoreScopes: options.ignoreScopes ? options.ignoreScopes.split(',') : undefined,
    ignoreModules: options.ignoreModules ? options.ignoreModules.split(',') : undefined,
    preambleText: options.preambleText ? [options.preambleText] : undefined,
    additionalText: options.additionalText ? [options.additionalText] : undefined,
  };
