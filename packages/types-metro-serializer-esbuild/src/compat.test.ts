...
import type { AllBuildOptions } from "./index.ts";
...
export type BaseAssignableToEsbuild = Assert<
  Extends<AllBuildOptions, EsbuildBuildOptions>
>;
 ...
 */
type OverlapKeys = keyof AllBuildOptions & keyof EsbuildBuildOptions;

export type OverlapStillCompatible = Assert<
  Extends<
    { [K in OverlapKeys]: AllBuildOptions[K] },
...
export type NoExtraKeys = Assert<
  Extends<keyof AllBuildOptions, keyof EsbuildBuildOptions>
>;
