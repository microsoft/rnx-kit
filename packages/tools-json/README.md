...
[![npm version](https://img.shields.io/npm/v/@rnx-kit/tools-json)](https://www.npmjs.com/package/@rnx-kit/tools-json)
...
```sh
yarn add @rnx-kit/tools-json --dev
```

or if you're using npm

```sh
npm add --save-dev @rnx-kit/tools-json
```
