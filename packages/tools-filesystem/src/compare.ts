...
import { type FSEntry } from "./entry";
 ...
 */
export function filesMatchSync(f1: FSEntry, f2: FSEntry): boolean {
 ...
 */
export async function filesMatch(f1: FSEntry, f2: FSEntry): Promise<boolean> {
  // do a quick stats comparison first to preempt more expensive checks if possible
