...
const E_EXPORT_ALL = "export-all";
const E_NO_NAMED_EXPORTS = "no-named-exports";
  ...
  create: (context) => {
    ...
    return {
      ExportAllDeclaration: (node) => {
        ...
        context.report({
          node,
          messageId: hasNamedExports ? E_EXPORT_ALL : E_NO_NAMED_EXPORTS,
          fix: (fixer) => {
            if (!hasNamedExports) {
              // We currently cannot fix this automatically as there are side
              // effects and other cases to consider. For now, just report it.
              return null;
            }
