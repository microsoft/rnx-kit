...
[![npm version](https://img.shields.io/npm/v/@rnx-kit/tools-knip)](https://www.npmjs.com/package/@rnx-kit/tools-knip)
...
```sh
yarn add @rnx-kit/tools-knip --dev
```

or if you're using npm

```sh
npm add --save-dev @rnx-kit/tools-knip
```
