...
| core-visionos                        | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               | Meta package for installing `react`                               |
